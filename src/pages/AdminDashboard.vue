  ...
  <q-page class="dashboard-page" :class="{ 'q-dark': isDark }">
    <q-container>
      ...
      <div class="dashboard-grid">
        <!-- Nombre de managés -->
        <q-item clickable tag="a" :href="'#/admin/nombre-manages-admin'" class="grid-item">
        ...
        <q-item clickable tag="a" :href="'#/admin/mon-prochain-entretien-personnel'" class="grid-item">
        ...
        <!-- Mon manager -->
        <q-item clickable tag="a" :href="'#/admin/mon-manager'" class="grid-item">
          <q-card class="dashboard-card">
            <q-card-section>
        ...
        <!-- Mon profil -->
        <q-item clickable tag="a" :href="'#/admin/mon-profil'" class="grid-item">
          <q-card class="dashboard-card">
            <q-card-section>
        ...
        <!-- Prochain entretien -->
        <q-item clickable tag="a" :href="'#/admin/mon-prochain-entretien'" class="grid-item">
          <q-card class="dashboard-card">
            <q-card-section>
